...
public class NetworkRestrictionPreferences extends SettingsPreferenceFragment implements
    ...
    @VisibleForTesting
    private LoaderManager.LoaderCallbacks<List<AppInfo>> mAppInfoLoaderCallbacks =
            new LoaderManager.LoaderCallbacks<List<AppInfo>>() {
    ...
    public void reloadAppList() {
        getLoaderManager().restartLoader(0, Bundle.EMPTY, mAppInfoLoaderCallbacks);
    }
